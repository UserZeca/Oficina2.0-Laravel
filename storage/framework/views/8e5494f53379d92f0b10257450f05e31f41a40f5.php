    ...
    <div class="flex-center position-ref full-height">
        <div class="content">
            ...
            <div class="links linkContainer">
                ...
                <a href="/cadastroDeOrcamento">Fazer orçamento</a>
            </div>
        </div>
    </div>
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Ezequias\Desktop\laravel\oficina2.0\CRUD\resources\views/welcome.blade.php ENDPATH**/ ?>